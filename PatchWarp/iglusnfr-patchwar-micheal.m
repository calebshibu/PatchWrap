...
ops.source_path = '/root/capsule/data/iGluSnFR_simulations/233';    % Directory that contains original tiff stack files
ops.save_path = '/root/capsule/results/233';    % Directory where motion corrected images will be saved
